...
<img src='https://www.herokucdn.com/deploy/button.svg'/></a></br><br>Более подробный мануал в 
<a href='https://github.com/xadjilut/microclient'>официальном репо</a>.</br>
<h3>Где гостевой аккаунт?</h3><br>На официальном сайте он временно недоступен лишь по той причине, что его существование 
кому-то явно мешает. Однако ты можешь поставить тапкофон локально и настроить сессию для гостевой учётки 
